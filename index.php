...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {  
  ...
  $converted_amount = convertCurrency($amount, $from, $to);
...
<head>
    <meta charset="UTF-8">
    <title>Currency-Exchange-Bootstrap-4</title>
    ...
    <div class="row">
      ...
      <div class="form-group">
			  ...
			  <div class="form-group">
                ...
                <input type="number" required placeholder="Input Any Amount" name="amount" id="input" class="form-control"/>
            </div>
			   <div class="form-group">
...
<option selected="" value="BND">Brunei Dollar (BND)</option>
...
<option value="ZWL">Zimbabwean Dollar (2009) (ZWL)</option>
			 ...
			 <div class="form-group">
                <label for="ecchange">Ecchange Ammount</label>
                <input type="number" name="amount_output" value="<?php echo @$converted_amount; ?>" readonly="readonly" id="ecchange" class="form-control"/>
            </div>
			<div class="form-group">
			<input type="submit" name="submit" value="Convert" class="form-control btn btn-outline-info btn-lg"></input>
              
            </div>
			<div class="form-group">
			 <input type="reset" name="reset" value="Reset" class="form-control btn btn-outline-warning btn-lg"></input>
            </div>
			</form>
		</div>
	</div>
